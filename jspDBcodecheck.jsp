...
<html lang="en">
  ...
  <body>
   ...
   <%
    ...
    ResultSet rs = stmt.executeQuery("SELECT CODE FROM jspDB where code = '"+code+"';");
     if(rs.next()){
...
if(checkCode==0){
 RequestDispatcher dispatcher = request.getRequestDispatcher("jspDBinsert.jsp");
